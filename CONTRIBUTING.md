...
LLMs AI code agent is fairly good for generating quality code on some subjects, based on limited scopes with clear prompt. If the majority of a code block is generated by AI code agent, there will be remarks like:
```cs
