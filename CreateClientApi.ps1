...
$processInfo2 = New-Object System.Diagnostics.ProcessStartInfo("C:\Program Files (x86)\Microsoft SDKs\TypeScript\2.0\tsc.exe", "$PSScriptRoot\DemoWebApi\Scripts\ClientApi\WebApiClientAuto.ts")
$process2 = [System.Diagnostics.Process]::Start($processInfo2)

$processInfo2 = New-Object System.Diagnostics.ProcessStartInfo("C:\Program Files (x86)\Microsoft SDKs\TypeScript\2.0\tsc.exe", "$PSScriptRoot\DemoAngular2\clientapi\WebApiNG2ClientAuto.ts")
$process2 = [System.Diagnostics.Process]::Start($processInfo2)
