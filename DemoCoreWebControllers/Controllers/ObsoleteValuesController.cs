...
namespace DemoWebApi.Controllers
{
	...
	public class ObsoleteValuesController : ControllerBase
	{
		...
		/// <returns></returns>
		[HttpGet]
		[Obsolete("This method is obsolete, use ValuesController.Get instead.")]
		...
		// POST api/values
		[HttpPost]
		[Obsolete("This method is obsolete, use ValuesController.Post instead. Not exported to client codes", true)]
