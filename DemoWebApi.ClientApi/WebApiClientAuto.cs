...
namespace DemoWebApi.Controllers.Client
{
	...
	public partial class Entities
	{
		...
		/// </summary>
		public async Task<DemoWebApi.DemoData.Client.Person> GetPersonActionNotFoundAsync(long id, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// GET api/Entities/PersonActionNotFound?id={id}
		/// </summary>
		public DemoWebApi.DemoData.Client.Person GetPersonActionNotFound(long id, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "api/Entities/PersonActionNotFound?id="+id;
			using (var httpRequestMessage = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
		...
		/// </summary>
		public async Task<DemoWebApi.DemoData.Client.Person> GetPersonNotFoundAsync(long id, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// GET api/Entities/PersonNotFound?id={id}
		/// </summary>
		public DemoWebApi.DemoData.Client.Person GetPersonNotFound(long id, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "api/Entities/PersonNotFound?id="+id;
			using (var httpRequestMessage = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
		...
		/// </summary>
		public async Task<System.Guid> LinkWithNewDecimalAsync(decimal id, DemoWebApi.DemoData.Client.Person p, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// POST api/Entities/linkNewDecimal?id={id}
		/// </summary>
		public System.Guid LinkWithNewDecimal(decimal id, DemoWebApi.DemoData.Client.Person p, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "api/Entities/linkNewDecimal?id="+id;
			using (var httpRequestMessage = new HttpRequestMessage(HttpMethod.Post, requestUri))
			{
		...
		/// </summary>
		public async Task<System.Guid> LinkWithNewGuidAsync(System.Guid id, DemoWebApi.DemoData.Client.Person p, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// POST api/Entities/linkNewGuid?id={id}
		/// </summary>
		public System.Guid LinkWithNewGuid(System.Guid id, DemoWebApi.DemoData.Client.Person p, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "api/Entities/linkNewGuid?id="+id;
			using (var httpRequestMessage = new HttpRequestMessage(HttpMethod.Post, requestUri))
			{
		...
		/// </summary>
		public async Task<long> LinkWithNewLongAsync(long id, DemoWebApi.DemoData.Client.Person p, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
		...
		/// POST api/Entities/linkLong?id={id}
		/// </summary>
		public long LinkWithNewLong(long id, DemoWebApi.DemoData.Client.Person p, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "api/Entities/linkLong?id="+id;
			using (var httpRequestMessage = new HttpRequestMessage(HttpMethod.Post, requestUri))
			{
	...
	public partial class Heroes
	{
		...
		/// </summary>
		public async Task<string> GetSomethingInvalidAsync(DemoWebApi.Controllers.Client.Hero h, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "api/Heroes/invalid";
			using (var httpRequestMessage = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
			if (handleHeaders != null)
			{
		...
		/// GET api/Heroes/invalid
		/// </summary>
		public string GetSomethingInvalid(DemoWebApi.Controllers.Client.Hero h, Action<System.Net.Http.Headers.HttpRequestHeaders> handleHeaders = null)
		{
			var requestUri = "api/Heroes/invalid";
			using (var httpRequestMessage = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
	...
	public partial class SuperDemo
	{
		...
		{
			var requestUri = "api/SuperDemo/AnonymousDynamic2";
			using (var httpRequestMessage = new HttpRequestMessage(HttpMethod.Get, requestUri))
			{
			if (handleHeaders != null)
			{
