...
{
	/// <summary>
	/// For handling DateOnly.MinValue. Recommended jsonSerializerSettings.DateParseHandling = Newtonsoft.Json.DateParseHandling.DateTimeOffset
	/// </summary>
	public sealed class DateTimeOffsetJsonConverter : JsonConverter<DateTimeOffset>
	{
		...
		public override DateTimeOffset ReadJson(JsonReader reader, Type objectType, DateTimeOffset existingValue, bool hasExistingValue, JsonSerializer serializer)
		{
			...
			if (vType == typeof(DateTimeOffset)) // when jsonSerializerSettings.DateParseHandling = Newtonsoft.Json.DateParseHandling.DateTimeOffset
			{
