...
2. Add [CodeGenController.cs](https://github.com/zijianhuang/webapiclientgen/blob/master/DemoCoreWebControllers/Controllers/CodeGenController.cs) to folder "Controllers"
...
```
4. Define the [settings of the CodeGen](https://github.com/zijianhuang/webapiclientgen/blob/master/DemoCoreWeb/CodeGen.json).
...
1. [.NET Client API in C#](https://github.com/zijianhuang/webapiclientgen/blob/master/DemoCoreWeb.ClientApiTextJson/WebApiClientTextJsonAuto.cs).
2. Client API in TypeScript [for Angular Reactive Forms](https://github.com/zijianhuang/webapiclientgen/blob/master/HeroesDemo/src/clientapi/WebApiCoreNG2FormGroupClientAuto.ts) or [for Fetch](https://github.com/zijianhuang/webapiclientgen/blob/master/fetchapi/src/clientapi/WebApiCoreFetchClientAuto.ts).
