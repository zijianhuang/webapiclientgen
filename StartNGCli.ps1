...
cd $PSScriptRoot
$arguments = "/site:DemoNGCli /apppool:Clr4IntegratedAppPool /config:$PSScriptRoot\.vs\config\applicationhost.config"
echo $arguments
...
Invoke-RestMethod https://localhost:50232/ -Method GET
