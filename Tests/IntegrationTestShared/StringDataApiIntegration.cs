...
namespace IntegrationTests
{
	...
	public partial class StringDataApiIntegration : IClassFixture<StringDataFixture>
	{
		...
		//[Fact]
		//public void TestGetABCDEAsText()
		//{
		//	Assert.Equal("ABCDE", api.GetABCDE((headers) =>
		//	{
		//		headers.TryAddWithoutValidation("Accept", "text/plain");
		//	})); //CodeGen StringAsString
		//}

		[Fact]
		public void TestGetABCDEAsJson()
		{
