...
namespace IntegrationTests
{
	...
	public class SuperDemoApiIntegration : IClassFixture<SuperDemoFixture>
	{
		...
		{
			Assert.Equal(0f, 0.1f + 0.2f - 0.3f);//.net core difference: In VS 2015 update 2, compiler makes it zeror. .net core and .net have different behaviors.
		...
		/// <summary>
		/// In .NET Core, null string is serialized as empty string in the body of text/plain.
		/// </summary>
		[Fact]
		...
		/// <summary>
		/// In .NET Core, empty string is serialized as "" in the body of text/plain.
		/// </summary>
		[Fact]
