...
namespace Fonlow.CodeDom.Web.Ts
{
	...
	public class ControllersTsNG2ClientApiGen : ControllersTsClientApiGenBase
	{
		...
		public ControllersTsNG2ClientApiGen(JSOutput jsOutput, bool handleHttpRequestHeaders) : base(jsOutput, new ClientApiTsNG2FunctionGen(jsOutput, handleHttpRequestHeaders))
		{
		}
