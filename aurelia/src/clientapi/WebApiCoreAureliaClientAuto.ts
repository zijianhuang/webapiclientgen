...
export namespace DemoWebApi_Controllers_Client {
    ...
    export class SuperDemo {
        ...
        getActionResult(): Promise<string> {
            return this.http.get('api/SuperDemo/ActionResult').then(d => d.text());
        }
        ...
        getChar(): Promise<string> {
            return this.http.get('api/SuperDemo/char').then(d => d.text());
        }
        ...
        postActionResult(): Promise<string> {
            return this.http.post('api/SuperDemo/ActionResult', null).then(d => d.text());
        }
        ...
        postActionResult2(s: string): Promise<string> {
            return this.http.post('api/SuperDemo/PostActionResult2', JSON.stringify(s), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.text());
        }
        ...
        postActionResult3(person: DemoWebApi_DemoData_Client.Person): Promise<string> {
            return this.http.post('api/SuperDemo/PostActionResult3', JSON.stringify(person), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.text());
        }
