...
export namespace DemoWebApi_Controllers_Client {
	export class Entities {
		...
		getMims(p: DemoWebApi_DemoData_Client.MimsPackage): Promise<DemoWebApi_DemoData_Client.MimsResult<string>> {
			return Axios.post<DemoWebApi_DemoData_Client.MimsResult<string>>(this.baseUri + 'api/Entities/Mims', JSON.stringify(p), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		getMyGeneric(s: DemoWebApi_DemoData_Client.MyGeneric<string, number, number>): Promise<DemoWebApi_DemoData_Client.MyGeneric<string, number, number>> {
			return Axios.post<DemoWebApi_DemoData_Client.MyGeneric<string, number, number>>(this.baseUri + 'api/Entities/MyGeneric', JSON.stringify(s), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		getMyGenericPerson(s: DemoWebApi_DemoData_Client.MyGeneric<string, number, DemoWebApi_DemoData_Client.Person>): Promise<DemoWebApi_DemoData_Client.MyGeneric<string, number, DemoWebApi_DemoData_Client.Person>> {
			return Axios.post<DemoWebApi_DemoData_Client.MyGeneric<string, number, DemoWebApi_DemoData_Client.Person>>(this.baseUri + 'api/Entities/MyGenericPerson', JSON.stringify(s), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		updatePerson(person: DemoWebApi_DemoData_Client.Person): Promise<string> {
			return Axios.put<string>(this.baseUri + 'api/Entities/updatePerson', JSON.stringify(person), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	}
	...
	export class Heroes {
		...
		getSomethingInvalid(h: DemoWebApi_Controllers_Client.Hero): Promise<string> {
			return Axios.get<string>(this.baseUri + 'api/Heroes/invalid').then(d => d.data);
		}
	...
	export class SuperDemo {
		...
		getAnonymousDynamic2(): Promise<AxiosResponse> {
			return Axios.get(this.baseUri + 'api/SuperDemo/AnonymousDynamic2');
		}
		...
		postGuids(guids: Array<string>): Promise<Array<string>> {
			return Axios.post<Array<string>>(this.baseUri + 'api/SuperDemo/Guids', JSON.stringify(guids), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
	...
	export class Tuple {
		...
		changeName(d: {item1: string, item2: DemoWebApi_DemoData_Client.Person}): Promise<DemoWebApi_DemoData_Client.Person> {
			return Axios.post<DemoWebApi_DemoData_Client.Person>(this.baseUri + 'api/Tuple/ChangeName', JSON.stringify(d), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
